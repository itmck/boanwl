...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/adminstyle.css" media="all">
    ...
    <div class="layui-side layui-side-bg layui-larry-side" id="larry-side">
        <div class="layui-side-scroll" id="larry-nav-side" lay-filter="side">
            ...
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="${pageContext.request.contextPath}/pages/main">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="javascript:;" data-url="${pageContext.request.contextPath}/pages/admin/changepwd">
                                <i class="iconfont icon-iconfuzhi01" data-icon='icon-iconfuzhi01'></i>
                                <span>修改我的密码</span>
                            </a>
                        </dd>
                        <dd>
                            <a href="javascript:;" data-url="${pageContext.request.contextPath}/pages/admin/list">
                                <i class="iconfont icon-jiaoseguanli2" data-icon='icon-piliangicon'></i>
                                <span>管理员列表</span>
                            </a>
                        </dd>
                        <dd>
                            <a href="javascript:;" data-url="${pageContext.request.contextPath}/pages/admin/myloginfo">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="javascript:;" data-url="${pageContext.request.contextPath}/pages/admin/myloginfo.html">
        ...
        <div class="layui-tab layui-tab-card larry-tab-box" id="larry-tab" lay-filter="demo" lay-allowclose="true">
            ...
            <div class="layui-tab-content" style="min-height: 150px; ">
                <div class="layui-tab-item layui-show">
                    <iframe class="larry-iframe" data-id='0' src="${pageContext.request.contextPath}/pages/main"></iframe>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/larry.js"></script>
...
<div class="lock-screen" style="display: none;">
    <div id="locker" class="lock-wrapper">
        ...
        <div class="lock-box center">
            <img src="${pageContext.request.contextPath}/static/images/userimg.jpg" alt="">
            <h1>admin</h1>
